...
def train(env_name,train_steps = 10000,suffix="",all_loss=0,\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    print(os.path.exists("DATA/LSPN_compare_sizeNNdata/"+suffix))
    logdir = "DATA/LSPN_compare_sizeNNdata/"+suffix+"/KoopmanNonlinearA_"+env_name+"layer{}_edim{}_eloss{}_gamma{}_aloss{}_detach{}_bdim{}_samples{}".format(layer_depth,encode_dim,e_loss,gamma,all_loss,detach,b_dim,Ktrain_samples)
    if not os.path.exists( "DATA/LSPN_compare_sizeNNdata/"+suffix):
        os.makedirs( "DATA/LSPN_compare_sizeNNdata/"+suffix)
...
if __name__ == "__main__":
    ...
    for i in env_names:
        ...
        parser.add_argument("--suffix",type=str,default="DKAC_withoutSOC_sizeNN_luorenz")
        ...
        parser.add_argument("--b_dim",type=int,default=0)
