...
def train(env_name,train_steps = 10000,suffix="",all_loss=0,\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "DATA/LSPN_compare_sizeNNdata/"+suffix+"/KoopmanU_"+env_name+"layer{}_edim{}_eloss{}_gamma{}_aloss{}_samples{}".format(layer_depth,encode_dim,e_loss,gamma,all_loss,Ktrain_samples)
...
if __name__ == "__main__":
    ...
    for j in env_names:
        ...
        parser.add_argument("--suffix",type=str,default="DKUC_withoutSOC_sizeNN_luorenz")
