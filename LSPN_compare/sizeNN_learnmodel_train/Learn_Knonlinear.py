...
def K_loss(data,net,u_dim=1,Nstate=4):
    ...
    # print("Max memory used during inference:", torch.cuda.max_memory_allocated())
    # memory_final = torch.cuda.max_memory_allocated()
    # print("Memory used: ", (memory_final - memory_begin)/1024)
...
def train(env_name,train_steps = 10000,suffix="",augsuffix="",\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "DATA/LSPN_compare_sizeNNdata/"+suffix+"/KNonlinear_"+env_name+augsuffix+"layer{}_AT{}_mode{}_samples{}".format(layer_depth,activation_mode,obs_mode,Ktrain_samples)
