...
def K_loss(data,net,u_dim=1,Nstate=4):
    ...
    # memory_final = torch.cuda.memory_allocated()
...
def train(env_name,train_steps = 10000,suffix="",augsuffix="",\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "DATA/LSPN_compare_sizeNNdata/"+suffix+"/KNonlinearRNN_"+env_name+augsuffix+"layer{}_AT{}_mode{}_samples{}".format(layer_depth,activation_mode,obs_mode,Ktrain_samples)
