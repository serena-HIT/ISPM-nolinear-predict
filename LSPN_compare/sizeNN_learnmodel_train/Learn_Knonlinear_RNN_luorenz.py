...
def train(env_name,train_steps = 10000,suffix="",augsuffix="",\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "DATA/LSPN_compare_sizeNNdata/"+suffix+"/KNonlinearRNN_"+env_name+"layer{}_AT{}_mode{}_samples{}".format(layer_depth,activation_mode,obs_mode,Ktrain_samples)
...
if __name__ == "__main__":
    ...
    for i in env_names:
        ...
        parser.add_argument("--suffix",type=str,default="KRNN_SOC_models_luorenz")
